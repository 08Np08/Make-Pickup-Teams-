...
def main():
    ...
    if choice == "1":
        ...
        team1,team2 = make_teams(offense_list,defense_list)
        ...
        team1_score, team2_score = team_score(team1,team2)
        ...
        team1, team1_score, team2, team2_score = make_fair_teams()
...
4 to switch position):")
    ...
    if choice == "1":
        ...
        for i in range(len(offense_list)):
            try:
                if str(offense_list[i]) == name:
                    offense_list[i].set_position("DEFENSE")
        ...
        for i in range(len(defense_list)):
            try:
                if str(defense_list[i]) == name:
                    defense_list[i].set_position("OFFENSE")
...
def team_score(team1,team2):
    ...
    return(team1_score,team2_score,team1_speed,team2_speed)
    
def make_fair_teams():

    o_list = open_forwards()
    d_list = open_defense()

    while True:
        team1, team2 = make_random_teams(o_list,d_list)
        team1_score,team2_score,team1_speed,team2_speed = team_score(team1,team2)
        speed_difference = team1_speed - team2_speed
        score_difference = team1_score - team2_score
        if abs(score_difference) < 3 :
            break
